...
usage() {
  cat <<'EOF'
Usage:
  ./run/wice/submit_tqa_b200.sh --jobs-file run/wice/tqa_wice_b200_gridsearch.txt
  ./run/wice/submit_tqa_b200.sh -- iha --fold 0 --lr 0.0001 --wd 0.0 --iha_init identity --iha_layers all --iha_lr 0.005
