...
case "$DATASET" in
  mustard) ARGS_FILE="${ROOT_DIR}/run/condor/mustard_synibu_nonpre.args" ;;
  urfunny) ARGS_FILE="${ROOT_DIR}/run/condor/urfunny_synibu_nonpre.args" ;;
  mosi)    ARGS_FILE="${ROOT_DIR}/run/condor/mosi_synibu_nonpre.args" ;;
  mosei)   ARGS_FILE="${ROOT_DIR}/run/condor/mosei_synibu_nonpre.args" ;;
