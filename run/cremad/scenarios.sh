...
DEFAULT_CONFIG_PATH="run/configs/cremad/default.json"
DEFAULT_TRAIN_SHOW_CONFIG="run/configs/cremad/default.json"
RMASK_CONFIG_PATH="run/configs/cremad/default.json"

print_cremad_scenarios() {
  cat <<'EOF'
Available CREMA-D scenarios:
  default
    - run/configs/cremad/default.json
