...
CUDA_VISIBLE_DEVICES=7 PYTHONPATH=src python -m synib.entrypoints.train --config run/configs/MUStARD/cache_iha.json  --default_config run/configs/MUStARD/default_config_mustard_cache.json --fold 0 --lr 0.0005 --wd 0.01 --validate_with accuracy --batch_size 4 --iha_lr 0.005 --pseudo_heads_q 16 --pseudo_heads_kv 8 --iha_init identity --iha_layers all
CUDA_VISIBLE_DEVICES=7 PYTHONPATH=src python -m synib.entrypoints.train --config run/configs/MUStARD/cache_iha_lora.json  --default_config run/configs/MUStARD/default_config_mustard_cache.json --fold 0 --lr 0.0005 --wd 0.01 --validate_with accuracy --batch_size 4 --iha_lr 0.005 --pseudo_heads_q 16 --pseudo_heads_kv 8 --iha_init identity --iha_layers all
