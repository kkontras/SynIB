...
class QtypeClassifier(DataProcessor):
    """Processor for question type classification dataset."""
    ...
    def get_train_examples(self, data_dir):
        """See base class."""
        return self._create_examples(self._read_tsv(os.path.join(data_dir, "qtype_clf_train_data.tsv")), "train")

    def get_dev_examples(self, data_dir):
        """See base class."""
        return self._create_examples(self._read_tsv(os.path.join(data_dir, "qtype_clf_dev_data.tsv")), "dev")

    def get_test_examples(self, data_dir):
        """See base class."""
        return self._create_examples(self._read_tsv(os.path.join(data_dir, "qtype_clf_test_data.tsv")), "dev")
...
glue_tasks_num_labels = {
    "qtype": len(ALL_QUESTION_TYPES),
}

glue_processors = {
    "qtype": QtypeClassifier,
}
