...
sys.path.append(os.path.abspath(os.path.join(current_dir, '../deps/vilbert-multi-task/')))
sys.path.append(os.path.abspath(os.path.join(current_dir, '../deps/vqa-maskrcnn-benchmark/')))
