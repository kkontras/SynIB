#!/usr/bin/env python3
"""Materialize a canonical raw CMU-MOSEI root for downstream cache building."""
...
def build_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Download or materialize canonical raw CMU-MOSEI data for cache building."
    )
