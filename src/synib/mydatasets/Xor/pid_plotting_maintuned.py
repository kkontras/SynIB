...
# file_path_main = "/esat/smcdata/users/kkontras/Image_Dataset/no_backup/git/Synergy/mydatasets/Xor/pid_synthetic_tuning/maintuned_valacc.jsonl"
...
file_path_synibleaned = "/esat/smcdata/users/kkontras/Image_Dataset/no_backup/git/Synergy/mydatasets/Xor/pid_synthetic_tuning/synib_mrand_valsynacc_nlrwddr.jsonl"
...
global_min = min(df[main_name].min(), df[synib_name].min(), df[synib_learned_name].min())
global_max = 1.0
...
axes[0, 2].scatter(x, y, c=df[synib_learned_name], s=sizes, cmap="RdPu", norm=norm1,
                   edgecolors="gray", linewidths=0.5)

title_fs = 9
axes[0, 0].set_title("(a) Select based on \n Validation Acc on Synergy", fontweight="semibold", fontsize=title_fs, pad=12)
axes[0, 1].set_title("(b) Select based on \n Validation Total Acc",    fontweight="semibold", fontsize=title_fs, pad=12)
axes[0, 2].set_title("(c) Select based on \n Validation Total Loss",   fontweight="semibold", fontsize=title_fs, pad=12)
...
axes[1, 2].scatter(x, y, c=df[synib_learned_name], s=sizes, cmap="RdPu", norm=norm2,
                   edgecolors="gray", linewidths=0.5)
...
# axes[1, 2].set_title(r"(c) Masked Dropout $M_{Random}$",   fontweight="semibold", fontsize=title_fs, pad=12)
...
fig.text(0.12, 0.5, "PID p = (Unique1, Redundancy, Synergy)", ha="left", va="top", fontsize=6)
...
plt.savefig("pid_maintuned.png", dpi=300, bbox_inches="tight")